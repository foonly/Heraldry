...
$tables = array(
    ...
    array(
        ...
        "cols" => array( // List the columns
            ...
            "height" => array("type"=>"double precision"),
            "width" => array("type"=>"double precision"),
            "xoffset" => array("type"=>"double precision"),
            "yoffset" => array("type"=>"double precision"),
            "scale" => array("type"=>"double precision"),
